...
\end{block}
\end{frame}
\begin{frame}[label=sec-7-1-7]{Herokuにディプロイ}
\begin{block}{ディプロイ}
ここまでのアプリをディプロイする
\end{block}
\end{frame}
...
\begin{frame}[label=sec-7-3-1]{Travis CIのWeb管理画面}
\end{frame}
\begin{frame}[label=sec-7-3-2]{GitHubとTravis CI連携}
\end{frame}
\begin{frame}[label=sec-7-3-3]{Travis経由でのHerokuへのdeploy}
\end{frame}
\section{＜演習課題＞}
\label{sec-7-4}

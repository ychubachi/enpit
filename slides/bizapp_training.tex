...
\end{block}
\end{frame}
\begin{frame}[label=sec-7-1-4]{動作確認}
\begin{block}{動作確認の方法}
\begin{itemize}
...
\label{sec-7-2}
\begin{frame}[fragile,label=sec-7-2-1]{テストについて}
 \begin{block}{ガイド}
\begin{itemize}
...
\label{sec-7-3}
\begin{frame}[label=sec-7-3-1]{Scaffoldの作成}
\end{frame}

\section{Travis CIとの連携}
\label{sec-7-4}
\begin{frame}[label=sec-7-4-1]{Travis CIのWeb管理画面}
\end{frame}
\begin{frame}[label=sec-7-4-2]{GitHubとTravis CI連携}
\end{frame}
\begin{frame}[label=sec-7-4-3]{Travis経由でのHerokuへのdeploy}
\end{frame}
...
\section{バージョン管理の概念}
\label{sec-14-2}
\begin{frame}[label=sec-14-2-1]{シナリオ}
...
\begin{frame}[label=sec-14-2-2]{バージョン管理の基礎知識}
\begin{block}{diff}
\end{block}
\begin{block}{patch}
\end{block}
...
\end{block}
\end{frame}
\begin{frame}[label=sec-14-2-3]{演習課題}
\begin{block}{演習課題}
\begin{itemize}
...
\begin{frame}[fragile,label=sec-14-2-4]{GitHubにpush}
 \begin{block}{コマンド}
\begin{minted}[]{bash}
